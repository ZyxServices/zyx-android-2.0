...
public class HotVenueFragment extends BaseFragment implements  SwipeRefreshLayout.OnRefreshListener{
    private View view;
    ...
    private void setData() {
        ...
        ArrayList<String> cacheData= (ArrayList<String>) CacheUtils.readJson(getActivity(), HotVenueFragment.this.getClass().getName() + ".json");
        if (cacheData==null||cacheData.size()==0) {
            new Thread() {
                ...
                public void run() {
                    ...
                    JSONParseUtil.parseNetDataVenue(getActivity(),result, HotVenueFragment.this.getClass().getName()+".json",datas, handler, HANDLE_DATA);
                }
            }.start();
        }else {
            JSONParseUtil.parseLocalDataVenue(getActivity(), HotVenueFragment.this.getClass().getName()+".json",datas, handler, HANDLE_DATA);
        }
    }
